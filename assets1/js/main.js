...
(function () {
	...
	(function () {
		...
		var settings = {
			...
			images: {
				'images1/bg01.jpg': 'center',
				'images1/bg02.jpg': 'center',
				'images1/bg03.jpg': 'center',
				'images1/bg04.jpg': 'center',
				'images1/bg05.jpg': 'center',
				'images1/bg06.jpg': 'center'
			},
		...
		var headersToAnimate = ["Click the button below to contact us", "點擊以下按鈕來聯繫我們"];
	...
	(function () {
		...
		$form.addEventListener('submit', function (event) {
			...
			window.setTimeout(function () {
				...
				window.location.href = "https://formsubmit.co/el/nozefu";
